...
def populate_impl_map(data_model):
    impl_map = {
        ...
        'parse_datetime': lambda x: data_algebra.default_data_model.pd.to_datetime(x, format=format),
        'parse_date': lambda x: data_algebra.default_data_model.pd.to_datetime(x, format=format).dt.date.copy(),
        'format_datetime': lambda x, format: x.dt.strftime(date_format=format),
        'format_date': lambda x: data_algebra.default_data_model.pd.to_datetime(x).dt.strftime(date_format=format),
