...
def test_select_rows_1():
    ...
    assert isinstance(d_sel, data_algebra.pandas_model.default_data_model.pd.DataFrame)
...
def test_select_rows_2():
    ...
    expect = data_algebra.pandas_model.default_data_model.pd.DataFrame({"x": [3.0], "y": [3.0]})
