...
def test_select_rows_1():
    ...
    assert isinstance(d_sel, data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame)
...
def test_select_rows_2():
    ...
    expect = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"x": [3.0], "y": [3.0]})
