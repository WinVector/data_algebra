...
def test_degenerate_project():
    ...
    expect = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"x2": [4],})
    ...
    expect3 = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame(
