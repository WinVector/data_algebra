...
def test_select_values_select_rows_1():
    ...
    expect1a = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame(
        {"c1": ["A", "A"], "c2": [1, 2],}
    )
    ...
    expect2 = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"c1": ["A"], "c2": [2],})
