...
def test_join_variations_1():
    ...
    data_algebra.test_util.check_transform(ops=ops1, data={'d1': d1, 'd2': d2}, expect=expect1)
    ...
    data_algebra.test_util.check_transform(ops=ops2, data={'d1': d1, 'd2': d2}, expect=expect2)
