...
def test_if_concat_is_stoopid_1():
    ...
    d1 = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"x": ["a"], "y": ["b"]})

    d2 = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"y": ["c"], "x": ["d"]})
