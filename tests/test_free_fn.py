...
def test_free_fn():
    ...
    d = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"b": [-1, 2]})
    ...
    data_algebra.data_model.data_model_type_map["default_data_model"].user_fun_map[
    ...
    del data_algebra.data_model.data_model_type_map["default_data_model"].user_fun_map["FUNCTION_WE_DONT_KNOW_ABOUT"]

    expect = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"b": [-1, 2], "r": [1, 2]})
