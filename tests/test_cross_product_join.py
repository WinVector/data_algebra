...
def test_cross_project_join_1():
    d1 = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"x": [1, 2, 3],})
    d2 = data_algebra.data_model.data_model_type_map["default_data_model"].pd.DataFrame({"y": ["a", "b", "c", "d"],})
